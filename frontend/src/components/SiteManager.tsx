...
import { sitesAPI, Site, SiteCreate } from '@/services/api';
...
export const SiteManager = ({ sites, setSites, isConnected }: SiteManagerProps) => {
  ...
  const toggleSiteActive = async (site: Site) => {
    try {
